...
const handleSaleVal =(index:Number,row:any) =>{
...
<div>
    ...
    >
      ...
      <el-table-column label="套餐名称" width="120" align="center" >
      ...
      <el-table-column label="套餐分类" align="center">
        <template #default="scope">
      ...
      <el-table-column label="操作"  align="center">
        <template #default="scope">
          ...
          <el-button
            ...
            size="small"
            text
            :type="scope.row.state == 0 ? 'primary' : 'danger'"
            @click="handleSaleVal(scope.$index, scope.row)"
          >
            <span v-if="scope.row.state == 0">启售</span>
            <span v-else>停售</span>
          </el-button>
        </template>
      </el-table-column>
